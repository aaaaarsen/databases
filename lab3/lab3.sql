...
SELECT department, COUNT(employees.department) FROM employees GROUP BY department;
...
SELECT name, city FROM employees WHERE city = 'Almaty'
UNION
SELECT name, city FROM customers WHERE city = 'Almaty';
...
DROP TABLE employees, departments, customers;
